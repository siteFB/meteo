...
if (isset($_GET['idUser']) && !empty($_GET['idUser'])) {
    ...
    $requete = $db->prepare('SELECT pseudo, titreMessage, idMessagerie, mesage, dateMess
FROM messagerie
LEFT JOIN users
...
');
    ...
    $requete->bindValue(':idUser', $id, PDO::PARAM_INT);

    $requete->execute();

    $msg_nbr = $requete->rowCount();   // nb de message d'un seul expéditeur
                            ...
                            ?>
                                <div class="wrapinput mb-5">
                                    ...
                                    <?php
                                       ...
                                       // protéger contre injection de l'id dans l'URL
                                        header('Location: /boitemail/recusAdmin.php');
                                    }
                                    ?>
                                </div>
